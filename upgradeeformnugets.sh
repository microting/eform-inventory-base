...
if (( "$GIT_STATUS" > 0 )); then
	...
	dotnet add Microting.eFormInventoryBase/Microting.eFormInventoryBase.csproj package Microting.eForm
	dotnet add Microting.eFormInventoryBase/Microting.eFormInventoryBase.csproj package Microting.eFormApi.BasePn
